...
import re
from deejayd.mediadb.parsers.video import fourcc
from deejayd.mediadb.parsers.video import language
from deejayd.mediadb.parsers.video.strutils import str_to_unicode, unicode_to_str
...
MEDIACORE = ['title', 'caption', 'comment', 'size', 'type', 'subtype',
             'timestamp', 'keywords', 'country', 'language', 'langcode', 'url',
             'artist', 'mime', 'datetime', 'tags', 'hash']
...
AVCORE = ['length', 'encoder', 'trackno', 'trackof', 'copyright', 'product',
          'genre', 'writer', 'producer', 'studio', 'rating', 'actors',
          'thumbnail', 'delay', 'image', 'video', 'audio', 'subtitles',
          'chapters', 'software', 'summary', 'synopsis', 'season', 'episode',
          'series']
