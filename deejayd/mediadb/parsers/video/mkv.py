...
import re
from deejayd.mediadb.parsers import ParseError
from deejayd.mediadb.parsers.video import core
from deejayd.mediadb.parsers.video.core import Tag, Tags
...
class EbmlEntity:
    ...
    def build_entity(self, inbuf):
        ...
        if self.id_len == 0:
            log.err(u'EBML entity not found, bad file format')
            raise ParseError()
