...
<html>
  ...
  <div id="errorMsg" style="width: 22em; position: absolute; left: %(left)s; margin-left: -11em; color: red; background-color: white; border: 1px solid red; padding: 4px; font-family: sans-serif">
