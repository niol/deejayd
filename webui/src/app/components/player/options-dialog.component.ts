  ...
  template: `
    ...
    <div md-dialog-content fxLayout="column">
      ...
      <div fxLayout="row"
        ...
        <div fxFlex="2 2 100%">
            <button (click)="setOption('av_offset', avOffsetInput.value)"
                    md-icon-button>
      ...
      <div fxLayout="row"
        ...
        <div fxFlex="2 2 100%">
            <button (click)="setOption('sub_offset', subOffsetInput.value)"
                    md-icon-button>
              <md-icon>send</md-icon>
            </button>
        </div>
